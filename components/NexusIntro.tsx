  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
      <div className="flex flex-col space-y-5">
        {/* Badge */}
        <div className="w-fit bg-[#008B94] text-white text-lg px-3 py-2 font-medium self-start">
          What is Nexus?
        </div>
        {/* Main Heading */}
        <h1 className="text-3xl lg:text-4xl font-semibold text-[#008B94] leading-tight">
