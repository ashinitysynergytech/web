...
import heroImg from "../public/assets/images/heroimage.svg";
			...
			<div>
				<main>
					<section className="py-12 md:py-24">
						<div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 xl:px-0">
							<div className="flex flex-col-reverse md:flex-row items-center justify-between gap-6">
								<div className="w-full md:w-1/2">
									<div className="max-w-md flex flex-col text-center md:text-left items-center md:items-start space-y-5">
										<h2 className="text-3xl md:text-5xl lg:text-[64px] text-[var(--color-primary)] font-black uppercase leading-tight md:leading-normal">
										...
										<div className="flex flex-col md:flex-row items-center gap-4 w-full">
											<button className="w-full md:w-auto px-4 py-2 rounded-full bg-[var(--btn-color)] hover:bg-opacity-90 text-white tracking-wide text-sm md:text-base">
												Book free consultation
											</button>
											<button className="w-full md:w-auto px-4 py-2 rounded-full border border-[var(--btn-color)] text-[var(--btn-color)] tracking-wide text-sm md:text-base">
